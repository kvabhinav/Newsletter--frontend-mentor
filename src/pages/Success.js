...
export default function Success() {
    return (
        <div className="bg-white w-[400px] h-[420px] rounded-3xl p-10 flex flex-col justify-between items-center">
            ...
            <p className='text-sm font-medium text-darkSlateGrey'>A confirmation email has been sent to <span className='font-bold'>ash@gmail.com</span> Please open it and click the button inside to confirm your subscription.</p>
