...
export default function ContentBox() {
    ...
    return (
        <div className="w-screen lg:w-max h-full rounded-xl px-6 pr-8 lg:p-10 lg:pr-[60px] flex-row justify-between items-center Roboto-Regular">
            <h1 className="text-darkSlateGrey text-4xl lg:text-5xl Roboto-Bold mt-6 lg:mt-0 mb-6 ">Stay Updated!</h1>
            ...
            <div className='grid grid-rows-2 gap-3 place-items-center'>
                ...
                <button className='text-white bg-darkSlateGrey hover:bg-gradient-to-r from-pink-500 to-tomato   w-80  lg:w-full h-14 text-center rounded-lg Roboto-Bold' onClick={clickHandle}>Subscribe to monthly newsletter</button>
            </div>
